...
int tsl2561_get_raw_light_intensity(uint8 *);

uint32 tsl2561_get_lux_light_intensity(uint8 *);
...
float sht21_get_caliberated_humidity(uint16 );
float sht21_get_caliberated_temperature(uint16 );
