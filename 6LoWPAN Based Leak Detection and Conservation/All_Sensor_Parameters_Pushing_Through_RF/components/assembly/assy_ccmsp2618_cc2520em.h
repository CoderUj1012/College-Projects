...
// SPI access macros
#define CC2520_SPI_BEGIN()              st( UCB1CTL1 &= ~UCSWRST; halMcuWaitUs(5); CC2520_CSN_OPIN(0); halMcuWaitUs(5); )
...
#define CC2520_SPI_END()                st( halMcuWaitUs(5); UCB1CTL1 |= UCSWRST; halMcuWaitUs(1); CC2520_CSN_OPIN(1); halMcuWaitUs(5); )
...
extern const digioConfig pinRadio_GPIO1;
extern const digioConfig pinRadio_GPIO2;
extern const digioConfig pinRadio_GPIO3;
extern const digioConfig pinRadio_GPIO4;
extern const digioConfig pinRadio_GPIO5;
