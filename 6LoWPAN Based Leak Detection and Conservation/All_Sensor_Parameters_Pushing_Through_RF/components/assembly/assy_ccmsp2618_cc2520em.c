...
const digioConfig pinRadio_GPIO1 = {1, 5, BIT5, HAL_DIGIO_INPUT,  0};
const digioConfig pinRadio_GPIO2 = {1, 6, BIT6, HAL_DIGIO_INPUT,  0};
const digioConfig pinRadio_GPIO3 = {1, 1, BIT1, HAL_DIGIO_INPUT,  0};
const digioConfig pinRadio_GPIO4 = {1, 2, BIT2, HAL_DIGIO_INPUT,  0};
const digioConfig pinRadio_GPIO5 = {1, 7, BIT7, HAL_DIGIO_INPUT,  0};
...
void halAssyInit(void)
{
    ...
    halDigioConfig(&pinRadio_GPIO1);
    halDigioConfig(&pinRadio_GPIO2);
    //halDigioConfig(&pinRadio_GPIO3);  //commented to avoid using gpio3 as it we need that pin for uart
    halDigioConfig(&pinRadio_GPIO4);
    halDigioConfig(&pinRadio_GPIO5);
#endif
}
