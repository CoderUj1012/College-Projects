...
#define HAL_INT_ON(x)      st( __bis_SR_register(GIE); )
#define HAL_INT_OFF(x)     st( __bic_SR_register(GIE); )
#define HAL_INT_LOCK(x)    st( (x) = __get_interrupt_state(); \
                               __bic_SR_register(GIE); )
#define HAL_INT_UNLOCK(x)  st( __bis_SR_register(x); /*_bis_SR_register(x);*/ )
#endif
