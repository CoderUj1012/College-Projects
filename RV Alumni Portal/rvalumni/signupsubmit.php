...
<div id="wrapper">
	...
	<div id="main-menu">
		<ul>
          ...
          <li></li>
			<li></li>
		    <li><a href="homepage.html" id="main-menu6" accesskey="6" title="">Back </a></li>
		    <li></li>
	    </ul>
  </div>
<div id="content">
		...
		<div id="right">
		  <h2 align="center" class="bigger">&nbsp;</h2>
			<form action="gallerysave.php" method="post" name="form1" id="form1">
              <p>&nbsp;</p>
              <p align="center" class="style2">YOUR INFORMATION WAS SUBMITTED SUCCESSFULLY.</p>
              <p align="center" class="style2">YOU WILL HAVE TO WAIT UNTIL THE ADMIN APPROVES YOUR </p>
              <p align="center" class="style2">CREDENTIALS.</p>
