...
if ($mysqli->connect_errno) 
{
	echo "Failed to connect to MySQL: (". $db->connect_errno . ") " . $db->connect_error;
			...
			$ename=$_POST["textfield"];
			$eid=$_COOKIE["sno"];
			$day=$_POST["textfield2"];
			$date=$_POST["textfield3"];
			$time=$_POST["textfield4"];
			$venue=$_POST["textfield5"];
			$picture=$_POST["textfield6"];
...
$query = "insert into events values ('$ename','$eid','$day','$date','$time','$venue','$picture')";
//echo $query;

mysqli_query($con,$query);
echo "<h2 align='center'>Event Added Successfully</h2>";
