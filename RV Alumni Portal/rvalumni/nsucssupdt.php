...
<div id="wrapper">
	...
	<div id="main-menu">
		<ul>
          ...
          <li></li>
			<li></li>
		    <li><a href="aeditpswd.html" id="main-menu6" accesskey="6" title="">Back </a></li>
		    <li></li>
	    </ul>
  </div>
<div id="content">
		...
		<div id="right">
		  <h2 align="center" class="bigger">&nbsp;</h2>
			<form action="gallerysave.php" method="post" name="form1" id="form1">
              <p>&nbsp;</p>
              <p align="center" class="style2">YOUR PASSWORD IS NOT UPDATED PROPERLY.</p>
              <p align="center" class="style2">PLEASE TRY AGAIN.</p>
              <p align="center">&nbsp;</p>
              <p align="center">&nbsp;</p>
              <p>&nbsp;</p>
              <p>&nbsp;</p>
